...
const Navbar = () => {
    return (
        <div className="bg-main3 flex sm:flex-row flex-col justify-center items-center w-[100dvw] h-[136px] sm:h-[119px] 2xl:gap-[400px] xl:gap-[350px] lg:gap-[150px] sm:gap-[50px] gap-[15px] pt-[10px] pb-[10px]">
            ...
            <div className="flex h-[78px] justify-center items-center gap-[25px]">
                ...
                <div className="flex justify-center items-center pt-[15px] pb-[15px] lg:h-[50px] lg:w-[138px] h-[35px] w-[99px]  rounded-xl border-solid border-main1 border-[2px]">
